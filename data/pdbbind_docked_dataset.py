...
class GridPDB:
    ...
    def adjust_atom_type(self, atom_data):
        for i in range(self.natom):
            data_i = atom_data[self.atomdata[i]]
            if data_i['smina_type'] in (
            SminaAtomType.AliphaticCarbonXSHydrophobe, SminaAtomType.AliphaticCarbonXSNonHydrophobe):
            ...
            elif data_i['smina_type'] in (
            SminaAtomType.AromaticCarbonXSHydrophobe, SminaAtomType.AromaticCarbonXSNonHydrophobe):
                if self._is_atom_bonded_to_hetero(i, atom_data):
