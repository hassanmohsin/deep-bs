...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--channels', type=str, default='kdeep', help='data channel [cno]')
    ...
    def parse(self, args=None):
        ...
        file_name = os.path.join(expr_dir, 'opt_train.txt') if self.opt.isTrain else os.path.join(expr_dir, 'opt_test.txt')
